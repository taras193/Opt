...
<body>
  <header>
    <div class="wrapper">
      ...
      <div class="label"></div>
      <div class="content">
        <h2>Увеличьте прибыль, работая с<br> надежным партнером. <span>Оптовые<br> поставки детской одежды</span><br> от производителя<sup>*</sup></h2>
...
и рекомендуют?</h2>
  ...
  <section class="sec3" id="sec3">
    <div class="wrapper">
      ...
      <div class="triger">
        <span class="togl">для самых<br> маленьких</span>
        <div class="toggle" data-page="0"></div>
        <span class="togr">для тех, кто<br> постарше</span>
      </div>
