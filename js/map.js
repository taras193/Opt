...
function init() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(43.483440, 43.604703), // New York
    ...
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(43.483440, 43.604703),
        map: map,
        icon:{url:'img/pointer.png',origin: new google.maps.Point(-151, 0),
